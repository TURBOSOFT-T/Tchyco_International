@section('titre', 'Liste des commentaires')
@extends('admin.fixe')
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('comment') }}">Les commentaires</a>
                                </li>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;">
                                            <div class="btn-group">
                                                ...
                                                <form action="{{ route('comment.destroy', $cat->id) }}" method="POST">
                                                    @csrf
                                            ...
                                            @if ($cat->active)
                                                <button class="btn btn-warning btn-sm"
                                                    onclick="confirmAction('{{ route('comment.disapprove', $cat->id) }}', 'Disapprove', 'Really disapprove this testimonial?')">
                                                    <i class="fas fa-times"></i> Disapprove
                                                </button>
                                            @else
                                                <button class="btn btn-success btn-sm"
                                                    onclick="confirmAction('{{ route('comment.approve', $cat->id) }}', 'Approve', 'Really approve this testimonial?')">
