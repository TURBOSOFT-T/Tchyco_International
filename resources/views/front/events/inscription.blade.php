...
@endphp
@php
    $title = \App\Helpers\TranslationHelper::TranslateText('Réservation');
    $subtitle = \App\Helpers\TranslationHelper::TranslateText('Réservation');
@endphp
@section('titre', \App\Helpers\TranslationHelper::TranslateText('Réservation'))
@section('body')
    ...
    <section class="contact-one">
        <div class="container">
            <div class="contact-one__inner">
                ...
                <form id="eventForm" class="contact-form-validated contact-one__form" method="POST" {{-- action="{{ route('event.confirm') }}" --}}>
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="contact-one__input-box text-message-box">
                                <textarea name="message" placeholder=" {{ \App\Helpers\TranslationHelper::TranslateText('Laissez une note') }}"
        ...
        <script>
            $(document).ready(function() {
                $('#eventForm').on('submit', function(e) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '{{ route('event.confirm') }}', // Assure-toi que cette route est correcte
                        data: formData,
