                                ...
                                @if ($events)
                                    <div class="blog-item mb-70">
                                        ...
                                        <div class="blog-content">
                                            ...
                                            <div class="blog-desc">{!!   {{ \App\Helpers\TranslationHelper::TranslateText($event->description ?? ' Pas de description') }} !!}</div>
                        ...
                        <div class="col-lg-3 pl-40 md-pl-15">
                            <div class="cl-sidebar">
                                ...
                                <div class="cl-recentpost mb-30">
                                    <h4 class="cl-widget-title">
                                          {{ \App\Helpers\TranslationHelper::TranslateText('Les derniers évènements') }}
                                    </h4>
                                    <ul>
                                        ...
                                        <li><a href="#">
                                          ...
                                          {{ \App\Helpers\TranslationHelper::TranslateText($lastevent->titre ?? '') }}
                                        </a></li>
                                        @endif
