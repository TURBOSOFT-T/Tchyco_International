...
<head>
    ...
    <title>Bienvenue chez MIRABELLE</title>
    <style>
        body {
...
<body>
    <div class="container">
       {{--  <div class="header">
        ...
        <div class="content">
            <h1>Bienvenue chez MIRABELLE !</h1>
            <p>Bonjour {{ $user->nom }} ,</p>
            <p>Votre mail est : {{ $user->email }} ,</p>
            <p>Votre mot de passe est : {{ $user->phone }} ,</p>

            <p>Nous sommes ravis de vous compter parmi nos nouveaux membres. Chez AGRIHUB, nous nous engageons à vous fournir le meilleur matériel de culture pour répondre à tous vos besoins.</p>
